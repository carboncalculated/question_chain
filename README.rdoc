...
Work in Progress!; We Are Extracting functionality this engine from our engine and is in active development; We are basically
making so other developers can use it;
...
There is a mongoid Branch if you wish to use mongoid

At the minute this has dependencies on MongoMapper (master branch)
